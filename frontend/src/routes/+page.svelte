    ...
    <nav class="flex items-center justify-between" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          <span class="sr-only">Sirris</span>
          <img class="h-8" src="https://www.sirris.be/themes/custom/sirris/logo.svg" alt="">
        </a>
      </div>
    ...
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">IoT Demo App on AWS</h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">A serverless starter app for IoT product builders.</p>
